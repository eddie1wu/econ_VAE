...
def plot_all_variables(real_data, gen_data):
    ...
    plot_histograms(real_data['hispanic'], gen_data['hispanic'].round(), 0, 3, 1, 'hispanic', bar_width=0.2)
    plot_histograms(real_data['married'], gen_data['married'].round(), 0, 3, 1, 'married', bar_width=0.2)
    plot_histograms(real_data['nodegree'], gen_data['nodegree'].round(), 0, 3, 1, 'nodegree', bar_width=0.2)
